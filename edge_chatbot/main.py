...
def single_round(inputs, streamer: TextStreamer, past_key_values=None):
    with torch.no_grad():
...
def stream_chat(debug=False):
    ...
    while True:
        ...
        if args.profile:
            ...
            outputs = single_round(inputs, streamer, past_key_values)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile", action="store_true",
                        help="whether to profile the inference performance.")
